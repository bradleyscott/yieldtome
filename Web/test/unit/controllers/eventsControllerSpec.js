describe('The Events controller', function() {
    ...
    var $controller, $log, $scope, $location, $q, EventService, AttendeeService;
    ...
    describe('when the user selects an Event', function() {
        ...
        xit("should display an error if there was a huge fail when trying to get the Attendees", function() {
            // Mock the getAttendees response
            var getAttendeesResponse = $q.defer();
